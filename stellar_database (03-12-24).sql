...
INSERT INTO `done_orders` (`uid`, `Product_id`, `Quantity`, `RefNo`, `var_id`) VALUES
...
(19201005, 6907010, 1, 1732897366, 0),
(87654321, 1234567, 2, 1727279293, 0);
...
--
-- 傾印資料表的資料 `password_requests`
--

INSERT INTO `password_requests` (`uid`, `request_time`) VALUES
(87654321, '2024-11-29 23:53:28');
...
(123456789, 'Test Product Long', 10.0, 'A Good Testing Product', 100, 5);
...
('June', 12131415, '5A', 1, 0, '$2y$10$0RDAt9ODqXSaI81T.KkVG.VlmrNpzyptdEVQyneCLkAO3J/ZhHECK'),
...
('Janey', 15164567, 'Hello', 28, 0, '$2y$10$K7pk0JeMhllK4vU6GsUV8utFPomMT9gY4cE1g4Excxq181bHsLKS6'),
('March', 16179876, '1F', 14, 0, '$2y$10$kDB94DoH.IoN2DU.g3Skgebdp3FL0zw4ctNabMUMkvoqlnwn5L9mC'),
('April', 17181234, '6D', 28, 0, '$2y$10$.Oa5PzTXm2LiLMDtC8wBFeNb1R9LlS7QPdPbbZuPYTbzP.WZUUNju'),
('Bane', 18191314, '99Z', 0, 0, '$2y$10$tsO0ddpiLz7GMF3jZpVE3uHdlNjAPXTR4BHUZ2O76Qi1jJp2RC8DK'),
('pencil', 18273645, '5C', 20, 1, '$2y$10$pc7beB3vwzKSfF7MNYkA4O0awfZZHADwbXdwfrCYdN/XNr1reMLL2'),
('Pencil_B', 19201005, '6C', 20, 1, '$2y$10$Iv/yxbvVaF113cUrbFsajOi5hqD76RuKRkLPX.Q5l.r2s4oXAxkvm'),
